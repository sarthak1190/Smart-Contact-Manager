...
public class UserController {
    ...
    //principal is used for fetching user details here
    @PostMapping("/process-contact")
    public String processContact(@ModelAttribute Contact contact,@RequestParam("profileImage") MultipartFile file, Principal p, Model m){
        try {
            ...
            //message success
            m.addAttribute("message", new Message("Successfully Added Contact !! Add new one.","alert-success"));

        } catch (Exception e) {
            System.out.println("ERROR: "+e.getMessage());
            e.printStackTrace();
            //message error
            m.addAttribute("message", new Message("Something went wrong, try again!","alert-danger"));
